...
export function NewCollectionCard() {
    ...
    return (
        <div className="border border-primary w-20vw h-20vh min-w-[100px] min-h-[100px] bg-secondary flex justify-center items-center rounded-lg " onClick={handleOpen} onKeyDown={(e) => { if (e.key === "Enter") handleOpen() }} role="button" tabIndex={0}>
